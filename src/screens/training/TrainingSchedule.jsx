...
async function sendTrainingEmail(userId, prefKey, subject, title, body) {
  ...
  const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Training in iLab →', ctaUrl: 'https://ilabapp.org/ilab/?screen=training', prefsUrl: 'https://ilabapp.org/ilab/?screen=profile', orgContact })

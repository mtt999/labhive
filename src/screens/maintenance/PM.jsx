...
async function sendNotification(userId, type, title, body, taskId = null) {
  ...
  if (prefs && prefs[`email_${type}`] === true) {
    ...
    if (toEmail) {
      ...
      const htmlBody = buildEmailHtml({ title, body, ctaLabel: 'View Task in iLab →', ctaUrl: 'https://labhive.app/?screen=pm', prefsUrl: 'https://labhive.app/?screen=profile', orgContact })
